...
namespace Regression03
{
    ...
    public class ZZD
    {
        ...
        private const string import4010 = batchPaths + "Import4010DentalZZD.bat";  //Batch File name here
        ...
        private const string HardCopy = hardCopies + "hardCopyZZD.txt";  //Specific import batch file name goes here
